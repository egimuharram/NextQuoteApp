...
class App extends Component {
  ...
  hitung = () => {
    ...
    if (imt < 18.5) {
      ...
      this.setState({info: 'Anda Obesitas!'})
    }
  }
        ...
        <Content style={styles.containerStyle}>
          <Form>
            ...
            <Item floatingLabel>
              ...
              <Input
                onChangeText=
                {(x) => {this.setState({tinggi: x})}}
                value={this.state.tinggi}/>
            </Item>
          </Form>
          <TouchableOpacity style={styles.buttonStyle} onPress= {() => {this.hitung()}}>
          ...
          <View style={styles.hasilContainer}>
            ...
            <Text style={styles.hasilStyle}>{this.state.tinggi / 100}
              m</Text>
