...
class App extends Component {
    ...
    klik = () => {
        ...
        var config = {
            headers: {
                'user-key': 'aadbd4e3d77753cb94f53d4fb1c71f96'
            }
        };
        axios
            .get(url, config)
            ...
            .map(resto => {
                return <Card style={{
                    ...
                    <CardItem cardBody>
                        <Image
                            source={{
                            uri: `${resto.restaurant.featured_image}`
                        }}
                            style={{
                            height: 200,
                            width: null,
            ...
            <Container>
                <Header searchBar rounded>
                    <Item>
                        ...
                        <Icon name="arrow-forward" onPress={this.klik}/>
                    </Item>
                    <Button transparent>
                        <Text onPress={this.klik}>
                            Cari
                        </Text>
                    </Button>
                </Header>
